...
namespace trainingSchoolv2.App_Code
{
    ...
    public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["conStrTrainingSchool"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["conStrTrainingSchool"].ConnectionString);
        public CRUD()
        {
            //
